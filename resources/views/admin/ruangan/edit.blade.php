    ...
    <main>
        ...
        <form method="POST" action="{{ route('admin.ruangan.update', $ruangan) }}">
            ...
            <p>
                ...
                <input id="nama_ruangan" name="nama_ruangan" type="text" value="{{ old('nama_ruangan', $ruangan->nama_ruangan) }}" maxlength="100" required>
                @error('nama_ruangan')
                    <span>{{ $message }}</span>
                @enderror
            </p>
            ...
            <p>
                ...
                <input id="lokasi" name="lokasi" type="text" value="{{ old('lokasi', $ruangan->lokasi) }}" maxlength="150" required>
                @error('lokasi')
                    <span>{{ $message }}</span>
                @enderror
            </p>
