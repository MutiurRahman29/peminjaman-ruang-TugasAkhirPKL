    ...
    <div class="mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 animate-fade-up animate-duration-[600ms] animate-ease-out">
            <nav class="mb-3 flex items-center gap-2 text-xs font-medium text-gray-400">
                ...
                <span>/</span>
                <span class="text-gray-200">Edit Fasilitas</span>
            </nav>
            ...
            <p class="mt-1 text-sm text-gray-400">
                Perbarui detail data fasilitas "{{ $fasilitas->nama_fasilitas }}" di dalam sistem.
            </p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.fasilitas.update', $fasilitas) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative rounded-xl shadow-sm">
                        ...
                        >
                            <option value="" disabled class="bg-gray-900 text-gray-500">Pilih kondisi fasilitas</option>
                            @foreach ($kondisiOptions as $kondisi)
                                <option value="{{ $kondisi->value }}" class="bg-gray-900 text-white" @selected(old('kondisi', $fasilitas->kondisi->value) === $kondisi->value)>
                                    {{ $kondisi->value }}
                                </option>
                            @endforeach
                        </select>
